...
namespace TMPro.Examples
{
    ...
    public class VertexShakeA : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("ScaleMultiplier")] public float m_scaleMultiplier = 1.0f;
        [FormerlySerializedAs("RotationMultiplier")] public float m_rotationMultiplier = 1.0f;
        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < lineCount; i++)
                {
                    ...
                    Quaternion rotation = Quaternion.Euler(0, 0, Random.Range(-0.25f, 0.25f) * m_rotationMultiplier);
                    ...
                    for (int j = first; j <= last; j++)
                    {
                        ...
                        float randomScale = Random.Range(0.995f - 0.001f * m_scaleMultiplier, 1.005f + 0.001f * m_scaleMultiplier);
